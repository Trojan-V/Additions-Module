...
public class GetSlotItemNbt extends BaseScriptAction {
    public GetSlotItemNbt() {
        super("getslotitemnbt");
    }
    ...
    public IReturnValue execute(IScriptActionProvider provider, IMacro macro, IMacroAction instance, String rawParams, String[] params) {
        ...
        if(params.length > 4)
            provider.setVariable(macro, params[4], slotUtils.getItemNbtTag());

        return new ReturnValue(slotUtils.getItemNbtTag());
    }
}
