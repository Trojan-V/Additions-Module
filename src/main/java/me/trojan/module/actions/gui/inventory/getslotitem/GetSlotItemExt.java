...
public class GetSlotItemExt extends BaseScriptAction {
    public GetSlotItemExt() {
        super("getSlotItemExt");
    }
    ...
    public IReturnValue execute(IScriptActionProvider provider, IMacro macro, IMacroAction instance, String rawParams, String[] params) {
        ...
        if(params.length > 4)
            provider.setVariable(macro, params[4], slotUtils.getItemDisplayName());

        return new ReturnValue(slotUtils.getItemDisplayName());
    }
}
