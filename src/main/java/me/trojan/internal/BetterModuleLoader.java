...
public class BetterModuleLoader implements IDirectoryStream {
    private static final String MODULE_FILE_REGEX = "^module_.*\\.jar$";
    private final File modulesDir;

    @SuppressWarnings("ResultOfMethodCallIgnored")
    public BetterModuleLoader(File macrosPath) {
    ...
    private boolean loadModuleClass(LaunchClassLoader classLoader, LoadedModuleInfo loadedModuleInfo, String className) {
        try {
            ...
            Log.info("ClassNotFoundException (BetterModuleLoader#loadModuleClass();) for class with className: " + className);
            e.printStackTrace();
        }
        return true;
    }
